class NotebookHandler {
    ...
    this.notebooks.forEach((notebook) => {
      notebook.addEventListener('click', () => {
        ...
        if (isOngoing) {
          ...
          const singleMessage = notebook.getAttribute('data-message');
          this.showSingleMessage(singleMessage);
        }
      });
    });
  }
  ...
  startMessageFlow(notebook) {
    ...
    const showNextMessage = (userResponse) => {
      ...
      this.showMessage(message, showNextMessage, true);
    };
  ...
  showSingleMessage(message) {
    this.showMessage(message, () => this.closeMessage(), false);
  }

  showMessage(message, onResponse, isOngoing) {
